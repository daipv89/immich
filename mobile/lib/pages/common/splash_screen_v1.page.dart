...
@RoutePage()
class SplashScreenV1Page extends StatefulHookConsumerWidget {
  const SplashScreenV1Page({super.key});

  @override
  SplashScreenV1PageState createState() => SplashScreenV1PageState();
}

class SplashScreenV1PageState extends ConsumerState<SplashScreenV1Page> {
  final log = Logger("SplashScreenV1Page");
  ...
  void resumeSession() async {
    ...
    if (accessToken != null && accessToken.isNotEmpty && serverUrl != null && endpoint != null) {
      ...
      ref.read(authProvider.notifier).saveAuthInfo(accessToken: accessToken).then(
        ...
        onError: (exception) => {
          ...
          context.replaceRoute(const LoginV1Route()),
        },
      );
    } else {
    ...
    if (context.router.current.name == SplashScreenV1Route.name) {
